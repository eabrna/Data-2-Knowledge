...
summary() for vectors of class 'factor' computes the number of times each level is repeated in the vector (in this case the number of cylinders, if applicable, in 1993 cars) 
