...
print(paste('As the liberation rate decreases by 50 MBtu/hr-ft2, we expect NOx emissions to increase by', final_prediction, 'ppm.'))
```
Part d: No, a liberation rate of 500 is outside the range of the data that the line is fit to, requiring extrapolation. It is unknown how well the line represents data outside of liberation rates of 100 to 400 and therefor should not be used to estimate values there. 
