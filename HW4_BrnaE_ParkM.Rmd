...
#### {.solution}
```{r}
pearson_nw = cor(neck, wrist, method = "pearson")
spearman_nw = cor(neck, wrist, method = "spearman")
kendall_nw = cor(neck, wrist, method = "kendall")

# Height vs Wrist 
pearson_hw = cor(height, wrist, method = "pearson")
spearman_hw = cor(height, wrist, method = "spearman")
kendall_hw = cor(height, wrist, method = "kendall")

print(paste('Correlations of Neck and Wrist:'))
print(paste('pearson method:',pearson_nw)) 
print(paste('spearman method:',spearman_nw)) 
print(paste('kendall method:',kendall_nw))

print(paste('Correlations of Height and Wrist:'))
print(paste('pearson method:',pearson_hw))
print(paste('spearman method:',spearman_hw))
print(paste('kendall method:',kendall_hw))
```
...
```{r}
exact_df <- fit1$df
print(paste('Slope =', fit$coefficients[1]))
print(paste('Intercept =', fit$coefficients[2]))
