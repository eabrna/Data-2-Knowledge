...
#### {.solution}
```{r}
# Neck vs Wrist - correlation tests and coefficients
cor.test(neck, wrist, alternative="greater", method="pearson")
cor.test(neck, wrist, alternative="greater", method="spearman")
cor.test(neck, wrist, alternative="greater", method="kendall")
...
# Height vs Wrist - correlation tests and coefficients
cor.test(height, wrist, alternative="greater", method="pearson")
cor.test(height, wrist, alternative="greater", method="spearman")
cor.test(height, wrist, alternative="greater", method="kendall")
