...
```{r}
# Neck vs Wrist
cor.test(neck, wrist, alternative="less", method="pearson")
cor.test(neck, wrist, alternative="less", method="spearman")
cor.test(neck, wrist, alternative="less", method="kendall")

# Height vs Wrist 
cor.test(height, wrist, alternative="less", method="pearson")
cor.test(height, wrist, alternative="less", method="spearman")
cor.test(height, wrist, alternative="less", method="kendall")
