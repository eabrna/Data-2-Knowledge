...
mtry_values <- c( 4, 6, 8, 10, 12, 14)    
ntree_values <- c(200, 300, 400, 500)  
...
for (m in 1:length(mtry_values)) {
  for (n in 1:length(ntree_values)) {
    ...
    # Store the average OOB MSE for this (mtry, ntree) combination
    results[m, n] <- mean(oob_mse)
  }
}

# Find the best mtry and ntree combination based on the lowest OOB MSE
